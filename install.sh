...
modify_agent_config() {
   ...
   # 增加--disable-auto-update，阻止agent自动更新
    sudo ${NZ_AGENT_PATH}/nezha-agent service install -s "$nz_grpc_host:$nz_grpc_port" -p $nz_client_secret $args --disable-auto-update >/dev/null 2>&1
